...
const OnboardingForm = ({industries}) => {
  ...
  <CardHeader>
    ...
    <CardDescription>Select your company to get a personalized  careere insights and recommendations </CardDescription>
  </CardHeader>
  <CardContent>
...
<div className='space-y-2'>
        ...
        <Input id='skills'  placeholder='eg. python,java' {...register("skills")}/>
